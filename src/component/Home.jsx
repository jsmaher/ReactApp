        ...
        return (
            <div>
                ...
                <div style={{marginLeft:"60%"}}>
                    <b>Timing: </b> {this.state.time.m} : {this.state.time.s}
                </div>
                <div className="ques">
                    <h2>Q : {quiz && quiz[num].question}</h2>
                    <div style={{width:"98%"}}>
                    {/**/}
                ...
                <div className="introQuiz">
                    <span className="introQuizS1"><h1>Title: Quiz App</h1></span>
                    <span className="introQuizS2"><h3>Class: Tiger Batch 01</h3> </span>
                ...
                {getRes ? 
                        ...
                        <div style={{padding:10,width:"100%",border:"1px solid gray",borderRadius:5}}>
                            <h2 style={{textAlign:"center",padding:"20px 10px",borderRadius:5,width:500}}></h2>
                            {resfail ?
                            <div style={{display:"flex",padding:"10px 35px 50px",}}>
                                <div style={{width:"100%",marginTop:"1%",textAlign:"center"}}>
                                    <b style={{color:"#13a89e",fontSize:"1.5em"}}>Passed</b>
                                     <br />
                            ...
                            <div style={{display:"flex",padding:"10px 35px 50px",}}>
                                <div style={{width:"100%",marginTop:"1%",textAlign:"center"}}>
                                    <b style={{color:"red",fontSize:"1.5em"}}>Failed</b>
                                     <br />
                                     <b>Result: {this.state.percent}%</b>
                                </div>
                            </div>
                            }
