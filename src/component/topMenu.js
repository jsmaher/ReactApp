      ...
      return(
          <div>
            <header id="header" >
                ...
                <p className="p1 p2" >
                <button onClick={this.props.click}  className="btnp1 btnp2" style={{border:"1px solid #fff",color:"white",background:"#333333",textTransform:"none",padding:"10px 35px"}}>
                    <span className="sp1">
                    <img src={this.props.img} style={{marginRight:"3px",borderRadius:"50px"}} width="50" height="50" alt=""/>
                    {this.props.value}
